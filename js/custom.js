  ...
  "use strict";
    ...
    window.addEventListener("scroll", () => {
        ...
        navLinks.forEach(link => {
            ...
            link.classList.toggle('active', targetTop <= scrollThreshold && targetTop + targetElement.clientHeight > scrollThreshold);
    ...
    window.addEventListener("scroll", () => {
        scrollToTopButton.style.display = window.scrollY > 150 ? "inline-flex" : "none";
    });
    ...
    message.innerHTML = '<span>"Thanks for visiting my portfolio. Feel free to explore!"</span> <button class="btn btn-sm btn-danger">Got it!</button>';
